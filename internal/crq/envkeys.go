...
var envKeys = []EnvKey{
	...
	{Key: "CRQ_STATE_GIT_AUTHOR_NAME", Kind: "text", Group: "identity", Label: "State Git author",
		Help: "Optional author name for commits made by the Git state fallback.", PerHost: true},
	{Key: "CRQ_STATE_GIT_AUTHOR_EMAIL", Kind: "text", Group: "identity", Label: "State Git email",
		Help: "Optional author email for commits made by the Git state fallback.", PerHost: true},
